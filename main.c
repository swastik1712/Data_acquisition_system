...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint32_t flashAddress = 0x08004000;
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(reading<0){
		  ...
		  data3[index]=voltage;
		  index++;
		  ftoa(voltage, data2, 8);
	  Flash_Write_Data (flashAddress,data2,8);
//	  Flash_Read_Data (flashAddress,Rx_Data,32);
